...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { avg_rating: @business.avg_rating, name: @business.name } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { avg_rating: @business.avg_rating, name: @business.name } }
